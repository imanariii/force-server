...
export declare const deserializeAws_restJson1PostToConnectionCommand: (output: __HttpResponse, context: __SerdeContext) => Promise<PostToConnectionCommandOutput>;
